 ...
 * @author Michael Lang
 */
public abstract class CollaboratorsCallbacks extends LoaderCallbacks<LoadedPage<User>> {
    private final Context mContext;
    private final RepositoryId mRepositoryId;

    public CollaboratorsCallbacks(BasePresenter presenter, Context context, String owner, String repoName) {
        super(presenter);
        mContext = context;
    ...
    public Loader<TaskResult<LoadedPage<User>>> onCreateLoader(int id, Bundle args) {
        ...
        PageIterator<User> pageIterator
                = service.pageCollaborators(mRepositoryId, Constants.PAGE_ITERATOR_SIZE);
