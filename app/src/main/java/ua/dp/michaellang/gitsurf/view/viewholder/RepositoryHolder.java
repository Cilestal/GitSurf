 ...
 * @author Michael Lang
 */
public class RepositoryHolder extends BaseHolder<Repository> {
    ...
    @Override
    public void bind(Context context, Repository data) {
        mRepository = data;
        mContext = context;

        String login = data.getOwner().getLogin();
        String repoTitle = context.getString(R.string.repo_title, login, data.getName());
